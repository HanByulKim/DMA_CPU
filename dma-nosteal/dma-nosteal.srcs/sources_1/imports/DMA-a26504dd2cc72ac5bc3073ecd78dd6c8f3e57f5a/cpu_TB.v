...
module cpu_TB();
    ...
    assign d_writeM = (cpu_d_writeM==1)? 2'b10: (dma_WRITE==1)? 2'b01: 2'b00;
    assign d_address = (d_writeM==2'b01)? dma_addr:cpu_addr;
    assign d_data = (d_writeM==2'b01)? dma_data:(d_writeM==2'b10)? cpu_data:64'bz; 
    assign cpu_data = (d_readM==1)? d_data : 64'bz;
    
	// instantiate the unit under test
	cpu UUT (clk, reset_n, i_readM, i_writeM, i_address, i_data, d_readM, cpu_d_writeM, cpu_addr, cpu_data, dma_start_int, dma_end_int, BR, BG, cmd, num_inst, output_port, is_halted);
